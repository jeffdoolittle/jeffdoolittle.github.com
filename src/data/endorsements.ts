export default {
  "endorsements": [
    ...
    },
    {
      ...
      "content": "Jeff has the exceptional ability to quickly and elegantly express ideas in clean, working code. He has experience in doing that in every aspect of a software project - server, mobile, web, \"cloud,\" whatever. He has courage to \"dive in\" and embrace new challenges. Combined with a passion for sharing his knowledge, an eagerness to engage with others, and a servant heart, he is a software engineering leader.\n"
    },
    {
      "reference": "David Chilcott, Founder & President, Outformations",
      "tagLine": "TWO BIG THUMBS UP!",
      "content": "I've worked with a lot of software architects and developers over the years and I have to say that Jeff is one of the best. His passion, creativity and craftsmanship make him a delight to work with. He is smart, personable and has great communication skills. He embodies Agile values, particularly Communication, Courage, and Respect. If you have an opportunity to collaborate with him, don't pass it up! TWO BIG THUMBS UP!\n"
    },
    {
      "reference": "Ward Bell, President, IdeaBlade",
      "tagLine": "Jeff Gets Things Done",
      "content": "Jeff is a top-notch professional who knows his stuff, cares about his customers, and gets things done. I always recommend Jeff enthusiastically and always sleep well when Jeff is on the case.\n"
    }
  ]
} as const;
